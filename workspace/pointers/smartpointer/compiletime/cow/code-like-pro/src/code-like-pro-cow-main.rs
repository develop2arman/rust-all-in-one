...
/// ## Commands
///
/// ```cargo run -q -p code-like-pro-cow_bin --bin code-like-pro-cow-main```
///
/// ```cargo doc  --package code-like-pro-cow_bin  --message-format short --no-deps --open --color always```
///
/// ```cargo test --doc  --package code-like-pro-cow_bin ```
///
/// ## What
/// `TODO`
///
