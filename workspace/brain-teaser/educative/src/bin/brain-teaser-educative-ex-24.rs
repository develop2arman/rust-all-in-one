...
///
/// brain-teaser-educative-ex-24
///
/// # Commands
///
/// ```RUST_BACKTRACE=full cargo run -q -p brain-teaser-educative_bin --bin brain-teaser-educative-ex-24```
///
...
///
/// ```cargo clippy --package brain-teaser-educative_bin --bin brain-teaser-educative-ex-24```
///
/// ## What
/// `TODO`
///
