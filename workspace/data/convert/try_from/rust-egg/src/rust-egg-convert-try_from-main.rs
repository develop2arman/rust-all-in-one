...
/// # Commands
///
/// ```cargo run -q -p rust-egg-convert-try_from_bin --bin rust-egg-convert-try_from-main```
///
/// ```cargo test -q -p rust-egg-convert-try_from_bin --bin rust-egg-convert-try_from-main```
///
