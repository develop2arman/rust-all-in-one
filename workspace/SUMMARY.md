...
- [TYPES](types/TYPES.md)
  ...
  - [SCALAR](types/TSCAL.md)    
    ...
    - [NON_NUMERIC](types/tscal/non_numeric/NON_NUMERIC.md)        
      - [STRING](types/tscal/non_numeric/string/STRING.md)
      - [CHAR](types/tscal/non_numeric/char/CHAR.md)
