...
/// ## Commands
///
/// ```cargo test -q -p packtpub-btree_lib```
///
/// ```cargo doc  --package packtpub-btree_lib  --message-format short --no-deps --open --color always```
///
/// ```cargo test --doc  --package packtpub-btree_lib```
///
/// ## What
/// `TODO`
///
