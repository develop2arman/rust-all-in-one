...
/// ## Commands
///
/// ```cargo run -q -p rust-doc-lazy_bin --bin rust-doc-lazy-main```
///
...
fn generate_workout(intensity: u32, random_number: u32) {
    ...
    if intensity < 25 {
        ...
        println!("Next, do {} situps!", expensive_result.value(9));
    } else {
        if random_number == 3 {
...
fn main() {
    ...
    let simulated_user_specified_value1 = 26;
    let simulated_random_number1 = 4;
