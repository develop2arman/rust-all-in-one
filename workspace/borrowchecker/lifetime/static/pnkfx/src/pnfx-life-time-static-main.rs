...
/// # Commands
///
/// ```cargo run -q -p pnfx-life-time-static_bin --bin pnfx-life-time-static-main```
///
/// ```cargo doc  --package pnfx-life-time-static_bin --message-format short --no-deps --open --color always```
///
/// ```cargo test --doc  --package pnfx-life-time-static_bin```
///
///
/// ## What
/// `TODO`
