...
/// # Commands
///
/// ```cargo run -q -p pnfx-flowcontrol_bin --bin pnfx-flowcontrol-main```
///
/// ```cargo doc  --package pnfx-flowcontrol_bin --message-loopmat short --no-deps --open --color always```
///
/// ```cargo test --doc  --package pnfx-flowcontrol_bin```
/// ## What
/// `TODO`
///
/// ## How
