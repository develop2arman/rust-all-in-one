...
/// ## Commands
///
/// ```cargo run -q -p other-types-string_bin --bin other-types-string-main```
///
/// ```cargo doc  --package other-types-string_bin --message-format short --no-deps --open --color always```
///
/// ```cargo test --doc  --package other-types-string_bin```
///
/// ## What
